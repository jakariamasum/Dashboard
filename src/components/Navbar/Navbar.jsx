...
const Navbar = () => {
    return (
        <div className='py-4 pl-2 items-center lg:flex justify-between bg-[#15132B] md:grid-cols-2 lg:grid-cols-4 lg:pr-32 lg:ml-[175px]'>
            <div class="relative">
                ...
                <input type="text" placeholder="Search here" class="input border-0 input-primary w-full max-w-xs pl-10 bg-[#211A75]" />
            </div>

            <div>
                <Link href='/' className='text-[#6418C3] underline'>OTHER MENUS</Link>
            </div>
            <div>
                <ul className="menu menu-horizontal  rounded-box">
                    <li className='indicator'>
                        ...
                        <Link href='/'>
                            <span className="indicator-item badge badge-secondaryary text-black bg-[#5ECFFF]">12</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    ...
                    <li>
                        <div className="indicator">
                            <Link href='/'>
                                <span className="indicator-item badge badge-secondaryary text-black bg-[#5ECFFF]">77</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    ...
                    <li className='indicator'>
                        <Link href='/'>
                            <span className="indicator-item badge badge-secondaryary text-black bg-[#5ECFFF]">2</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    ...
                    <li className='indicator'>
                        <Link href='/'>
                            <span className="indicator-item badge badge-secondaryary bg-[#E328AF] text-black">1</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
            ...
            <div class="flex items-center gap-2 p-1 bg-[#211A75] rounded-[46px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                ...
                <select class="select select-primary border-0 bg-[#211A75] rounded-[46px] w-[125px] h-[48px]">
