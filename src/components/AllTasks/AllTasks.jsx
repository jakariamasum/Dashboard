...
const AllTasks = () => {
    return (
        <div className='mt-7 pl-2 bg-[#15132B] py-4 lg:pr-32 lg:ml-[175px]'>
            <div className=' lg:flex justify-between'>
                <div>
                    <div className='flex'>
                        ...
                        <h1 className="font-bold text-4xl text-white">School November Tasks</h1>
                    </div>
                    <p className='text-[#A5A5A5]'>Created by Instructor Day on November 31, 2022</p>
                </div>
                <div className='flex flex-reverse items-center justify-center'>
                    <div>
                        <h1 className='text-[18px] text-white font-bold'>Centered Martial Arts</h1>
                        <p className='text-[#A5A5A5]'>Sunnyvale, Ca</p>
                    </div>
                    <div className='ml-[18px] mr-[25px] w-[60px] h-[60px] bg-white rounded-xl flex justify-center items-center'>
            ...
            <div className="pt-8 lg:flex justify-between items-center gap-5">
                <div className="avatar-group -space-x-6 flex">
                ...
                <div className="lg:flex">
                    <div className="lg:flex md:space-x-4">
                        <div className='flex gap-6 lg:gap-4'>
                            <Button txtColor="white" bg="#6418C3" buttonWidth="150px" text="Invite People" />
                            <Button txtColor="white" bg="" buttonWidth="80px" text="Private" bWidth="2px" bClor="#7879F1" />
                        </div>
                        <div className='flex gap-6 lg:gap-4'>
                            <Button txtColor="white" bg="#7879F1" buttonWidth="70px" text="Edit" />
                            <Button txtColor="white" bg="" buttonWidth="150px" text="45 Comments" bWidth="2px" bClor="#7879F1" />
                        </div>
                    </div>
                </div>
                <div className="sm:mt-2 lg:flex items-center">
                    <h1 className='mr-1'>Total Progress: </h1>
                    <div style={{ width: '200px', backgroundColor: '#1E1C3A' }}>
                        <ProgressBar progressValue="40" progressColor="#6418C3" />
                    </div>
                </div>
            </div>
        </div>
